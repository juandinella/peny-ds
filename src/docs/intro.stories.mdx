...
1. Install: `npm i @ripio/eos-ds --save`
2. Import styles in your index.js: `import '@ripio/eos-ds/index.css'`
3. Add provider before router:

```
import { DesignSystemProvider } from '@ripio/eos-ds'
const App = () =>
...
```
import { Button } from '@ripio/eos-ds'
const MyComp = () =>
  <Button id="my_id">
    My button!
  </Button>
...
1. Clone repository. `git clone git@git.in.ripio.com:ripio_public/eos-ds.git`
